object Deleted_T: TDeleted_T
  ...
  object FDQuery: TFDQuery
    ...
    SQL.Strings = (
      'select t.ID, t.kArtikel, parent.cArtNr'
      '  from Umlagerung.dbo.tArtikelDeleted t (nolock)'
      '  LEFT JOIN [eazybusiness].[dbo].[tArtikel] parent (nolock)    '
      '         ON t.kArtikel = parent.kArtikel')
    Left = 487
    Top = 220
  end
  object FDUpdateSQL: TFDUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO Umlagerung.dbo.[tArtikelDeleted]'
      '            (kArtikel)'
      'VALUES (:NEW_kArtikel);'
      ''
      'SELECT SCOPE_IDENTITY() AS ID')
    ModifySQL.Strings = (
      'UPDATE Umlagerung.dbo.[tArtikelDeleted]'
      '   SET kArtikel= :NEW_kArtikel'
      ' WHERE ID = :Old_ID')
    DeleteSQL.Strings = (
      'DELETE FROM Umlagerung.dbo.[tArtikelDeleted] WHERE ID= :OLD_ID')
    FetchRowSQL.Strings = (
      'SELECT *'
      '  FROM Umlagerung.dbo.[tArtikelDeleted] (nolock)'
      ' WHERE  ID = :OLD_ID')
    Left = 485
    Top = 294
  end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object AusgeblendeteArtikelneinblenden1: TMenuItem
      Caption = 'Ausgeblendete Artikeln einblenden'
      ImageIndex = 2
      OnClick = AusgeblendeteArtikelneinblenden1Click
    end
  end
end
